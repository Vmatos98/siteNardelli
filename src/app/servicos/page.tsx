    ...
    <div className="bg-slate-50 text-slate-800">
      ...
      <header className="fixed w-full z-50 bg-white/95 backdrop-blur-sm shadow-md transition-all duration-300">
        ...
        <div id="mobile-menu" className="hidden absolute top-full left-0 w-full bg-white border-t md:hidden flex-col shadow-lg">
          <Link href="/" className="block px-6 py-4 border-b hover:bg-slate-50">Home</Link>
          <Link href="/#empresa" className="block px-6 py-4 border-b hover:bg-slate-50">Empresa</Link>
          <Link href="/#clientes" className="block px-6 py-4 border-b hover:bg-slate-50">Clientes</Link>
          <span className="block px-6 py-4 border-b bg-orange-50 text-orange-600 font-bold">Serviços</span>
          <Link href="/#contato" className="block px-6 py-4 border-b hover:bg-slate-50">Contato</Link>
